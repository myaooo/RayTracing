...
namespace RayTracing {
    ...
    const Material
        ...
        Material::GLASS(Color::WHITE * M_DIFFUSE_L, SPECULATE_MIRROR, TRANSPARENT, M_AMBIENT_L, M_SHIN_SMOOTH,M_REFRACTIVITY),
        Material::MIRROR(Color::WHITE* M_DIFFUSE_L, SPECULATE_MIRROR, Color::NONE, M_AMBIENT_L, M_SHIN_SMOOTH),
        Material::WHITE_MIRROR(Color::WHITE * M_DIFFUSE, SPECULATE_NORMAL, Color::NONE, M_AMBIENT_M, M_SHIN_LOW),
        Material::BLACK_MIRROR(Color::BLACK * M_DIFFUSE, SPECULATE_NORMAL, Color::NONE, M_AMBIENT_M, M_SHIN_LOW);
}